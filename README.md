...
6. **Benefícios de lançamento** — o bloco com os dois benefícios dos primeiros advisors aprovados (comissão fixa de 80% de repasse e R$ 10.000 em verba de marketing) está na página, logo abaixo da calculadora, e também no aviso legal do rodapé. **Confirmar antes de publicar:** a última informação registrada era de que a verba de marketing seguia em validação, e os critérios de elegibilidade nunca foram definidos, então a página fala em "primeiros advisors" sem cravar quantidade.
   > Os 80% fixos **não** contradizem a calculadora, e a copy diz isso com todas as letras: o repasse vai de 70% a 80% para todo mundo, e o benefício de lançamento é ter o **teto travado em contrato** em vez da faixa. Se um dia esse benefício sair, o bloco inteiro sai junto com o trecho correspondente do aviso legal.
